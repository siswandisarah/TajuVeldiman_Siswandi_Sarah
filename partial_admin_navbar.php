  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
       ...
       <!--  <img src="../../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8"> -->
        <span class="brand-text font-weight-light"><h6><b>Halaman <br>Admin</b></h6></span>
      </a>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="<?php echo site_url('/Admin/informasi_racun')?>" class="dropdown-item">Informasi Pestisida</a></li>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('/Admin/proses_penanaman_dan_proses_panen/') ?>" class="nav-link"><b>Proses tanam dan panen</b></a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('/Admin/user/changepassword') ?>" class="nav-link"><b>Ubah Password</b></a>
          </li>
